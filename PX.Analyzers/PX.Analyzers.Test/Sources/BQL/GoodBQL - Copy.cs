...
namespace PX.Objects.SO
{
	public class GoodBqlGraph : PXGraph<GoodBqlGraph>
	{
		public PXSelectJoin<BCBudgetBalance, 
			 ...
			 OrderBy<
				   Asc<BCBudgetBalance.ytdAmount, 
				   Asc<BCBudgetBalance.finPeriodID, 
				   Asc<BCBudgetBalance.amount>>>>>
		bqlSelect;
		...
		public void Select()
		{
			...
			int subledgerID = 9;
			 ...
			 var query = 
				PXSelect<BCBudgetBalance,
			   Where<BCBudgetLedger.summarize, Equal<Required<BCBudgetLedger.summarize>>,
				 And<BCBudgetBalance.subledgerID, Equal<Required<BCBudgetBalance.subledgerID>>>>,
			 OrderBy<
				   Asc<BCBudgetBalance.ytdAmount,
				   Asc<BCBudgetBalance.finPeriodID,
				   Asc<BCBudgetBalance.amount>>>>>
			.Select(this, summarize, false);
		}
	}
}
