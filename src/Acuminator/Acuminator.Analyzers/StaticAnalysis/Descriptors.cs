...
namespace Acuminator.Analyzers.StaticAnalysis
{
	...
	public static class Descriptors
	{
		...
		public static DiagnosticDescriptor PX1005_TypoInViewDelegateName { get; } = 
            Rule("PX1005", nameof(Resources.PX1005Title).GetLocalized(), Category.Acuminator, DiagnosticSeverity.Warning, 
		...
		public static DiagnosticDescriptor PX1066_TypoInBqlFieldName { get; } =
			Rule("PX1066", nameof(Resources.PX1066TitleFormat).GetLocalized(), Category.Acuminator, DiagnosticSeverity.Error, DiagnosticsShortName.PX1066);
