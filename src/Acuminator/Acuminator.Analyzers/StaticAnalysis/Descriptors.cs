	...
	public static class Descriptors
	{
		...
		public static DiagnosticDescriptor PX1005_TypoInViewDelegateName { get; } = 
            Rule("PX1005", nameof(Resources.PX1005Title).GetLocalized(), Category.Default, DiagnosticSeverity.Warning, 
	            DiagnosticsShortName.PX1005, nameof(Resources.PX1005MessageFormat).GetLocalized());
		...
		public static DiagnosticDescriptor PX1022_NonPublicDacExtension { get; } =
			Rule("PX1022", nameof(Resources.PX1022DacTitle).GetLocalized(), Category.Default, DiagnosticSeverity.Error,
				 DiagnosticsShortName.PX1022Dac);

		public static DiagnosticDescriptor PX1022_NonPublicGraphExtension { get; } =
			Rule("PX1022", nameof(Resources.PX1022GraphTitle).GetLocalized(), Category.Default, DiagnosticSeverity.Error,
		...
		public static DiagnosticDescriptor PX1036_WrongDacUniqueKeyName { get; } =
			Rule("PX1036", nameof(Resources.PX1036UKTitle).GetLocalized(), Category.Default, DiagnosticSeverity.Warning,
				DiagnosticsShortName.PX1036UK);
		...
		public static DiagnosticDescriptor PX1043_SavingChangesInRowPerstisting { get; } =
			Rule("PX1043", nameof(Resources.PX1043TitleRowPersisting).GetLocalized(), Category.Default, DiagnosticSeverity.Error, DiagnosticsShortName.PX1043);

		public static DiagnosticDescriptor PX1043_SavingChangesInRowPerstistedNonISV { get; } =
			Rule("PX1043", nameof(Resources.PX1043TitleRowPersistedNonISV).GetLocalized(), Category.Default, DiagnosticSeverity.Warning, DiagnosticsShortName.PX1043);
		...
		public static DiagnosticDescriptor PX1045_PXGraphCreateInstanceInEventHandlers { get; } =
			Rule("PX1045", nameof(Resources.PX1045Title).GetLocalized(), Category.Default, DiagnosticSeverity.Error, DiagnosticsShortName.PX1045);

		public static DiagnosticDescriptor PX1045_PXGraphCreateInstanceInEventHandlers_NonISV { get; } =
			Rule("PX1045", nameof(Resources.PX1045Title).GetLocalized(), Category.Default, DiagnosticSeverity.Warning, DiagnosticsShortName.PX1045);

		public static DiagnosticDescriptor PX1046_LongOperationInEventHandlers { get; } =
			Rule("PX1046", nameof(Resources.PX1046Title).GetLocalized(), Category.Default, DiagnosticSeverity.Error, DiagnosticsShortName.PX1046);
        ...
        public static DiagnosticDescriptor PX1052_IncorrectStringToFormat { get; } =
            Rule("PX1052", nameof(Resources.PX1052Title).GetLocalized(), Category.Default, DiagnosticSeverity.Error, DiagnosticsShortName.PX1052);

        public static DiagnosticDescriptor PX1053_ConcatenationPriorLocalization { get; } =
            Rule("PX1053", nameof(Resources.PX1053Title).GetLocalized(), Category.Default, DiagnosticSeverity.Error, DiagnosticsShortName.PX1053);
        ...
        public static DiagnosticDescriptor PX1057_PXGraphCreationDuringInitialization_NonISV { get; } =
	        Rule("PX1057", nameof(Resources.PX1057Title).GetLocalized(), Category.Default, DiagnosticSeverity.Warning, DiagnosticsShortName.PX1057);
		...
		public static DiagnosticDescriptor PX1060_LegacyBqlField { get; } =
			Rule("PX1060", nameof(Resources.PX1060Title).GetLocalized(), Category.Default, DiagnosticSeverity.Info, DiagnosticsShortName.PX1060);
		...
		public static DiagnosticDescriptor PX1071_PXActionExecutionInEventHandlers { get; } =
			Rule("PX1071", nameof(Resources.PX1071Title).GetLocalized(), Category.Default, DiagnosticSeverity.Error, DiagnosticsShortName.PX1071);
		...
		public static DiagnosticDescriptor PX1073_ThrowingExceptionsInRowPersisted_NonISV { get; } =
			Rule("PX1073", nameof(Resources.PX1073Title).GetLocalized(), Category.Default, DiagnosticSeverity.Warning, DiagnosticsShortName.PX1073);
		...
		public static DiagnosticDescriptor PX1075_RaiseExceptionHandlingInEventHandlers { get; } =
			Rule("PX1075", nameof(Resources.PX1075Title).GetLocalized(), Category.Default, DiagnosticSeverity.Error, DiagnosticsShortName.PX1075,
        ...
        public static DiagnosticDescriptor PX1081_PXGraphExecutesActionDuringInitialization { get; } =
            Rule("PX1081", nameof(Resources.PX1081Title).GetLocalized(), Category.Default, DiagnosticSeverity.Error, DiagnosticsShortName.PX1081);

        public static DiagnosticDescriptor PX1082_ActionExecutionInDataViewDelegate { get; } =
            Rule("PX1082", nameof(Resources.PX1082Title).GetLocalized(), Category.Default, DiagnosticSeverity.Error, DiagnosticsShortName.PX1082);

        public static DiagnosticDescriptor PX1083_SavingChangesInDataViewDelegate { get; } =
            Rule("PX1083", nameof(Resources.PX1083Title).GetLocalized(), Category.Default, DiagnosticSeverity.Error, DiagnosticsShortName.PX1083);

        public static DiagnosticDescriptor PX1084_GraphCreationInDataViewDelegate { get; } =
            Rule("PX1084", nameof(Resources.PX1084Title).GetLocalized(), Category.Default, DiagnosticSeverity.Error, DiagnosticsShortName.PX1084);

        public static DiagnosticDescriptor PX1085_DatabaseQueriesInPXGraphInitialization { get; } =
            Rule("PX1085", nameof(Resources.PX1085Title).GetLocalized(), Category.Default, DiagnosticSeverity.Warning, DiagnosticsShortName.PX1085);

        public static DiagnosticDescriptor PX1086_ThrowingSetupNotEnteredExceptionInLongRunningOperation { get; } =
            Rule("PX1086", nameof(Resources.PX1086Title).GetLocalized(), Category.Default, DiagnosticSeverity.Warning, DiagnosticsShortName.PX1086);
        ...
        public static DiagnosticDescriptor PX1090_ThrowingSetupNotEnteredExceptionInActionHandlers { get; } =
            Rule("PX1090", nameof(Resources.PX1090Title).GetLocalized(), Category.Default, DiagnosticSeverity.Warning, DiagnosticsShortName.PX1090);

        public static DiagnosticDescriptor PX1091_CausingStackOverflowExceptionInBaseActionHandlerInvocation { get; } =
            Rule("PX1091", nameof(Resources.PX1091Title).GetLocalized(), Category.Default, DiagnosticSeverity.Warning, DiagnosticsShortName.PX1091);

        public static DiagnosticDescriptor PX1092_MissingAttributesOnActionHandler { get; } =
            Rule("PX1092", nameof(Resources.PX1092Title).GetLocalized(), Category.Default, DiagnosticSeverity.Error, DiagnosticsShortName.PX1092);

		public static DiagnosticDescriptor PX1093_GraphDeclarationViolation { get; } =
			Rule("PX1093", nameof(Resources.PX1093Title).GetLocalized(), Category.Default, DiagnosticSeverity.Error, DiagnosticsShortName.PX1093);
