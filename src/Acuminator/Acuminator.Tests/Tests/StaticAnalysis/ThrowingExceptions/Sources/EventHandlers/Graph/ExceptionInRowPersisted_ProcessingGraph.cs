...
{
	public class SOInvoiceProcessing : PXGraph<SOInvoiceProcessing, SOInvoice>
	{
		[PXFilterable]
		public PXProcessing<SOInvoice> InvoicesList;        //Processing view makes this a procesing graph
