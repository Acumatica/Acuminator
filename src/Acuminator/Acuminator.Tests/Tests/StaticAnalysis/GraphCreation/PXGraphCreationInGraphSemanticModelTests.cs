...
namespace Acuminator.Tests.Tests.StaticAnalysis.GraphCreation
{
    public class PXGraphCreationInGraphSemanticModelTests : DiagnosticVerifier
    {
        ...
        public async Task ViewDelegate(string source) =>
            await VerifyCSharpDiagnosticAsync(source, Descriptors.PX1084_GraphCreationInDataViewDelegate.CreateFor(13, 25));

        [Theory]
        [EmbeddedFileData("ViewDelegateWithParameter.cs")]
        public async Task ViewDelegateWithParameter(string source) =>
            await VerifyCSharpDiagnosticAsync(source, Descriptors.PX1084_GraphCreationInDataViewDelegate.CreateFor(13, 30));
        ...
        public async Task ViewDelegateInGraphExtensionOwnView(string source) =>
            await VerifyCSharpDiagnosticAsync(source, Descriptors.PX1084_GraphCreationInDataViewDelegate.CreateFor(12, 33));
        ...
        public async Task ViewDelegateInGraphExtensionBaseView(string source) =>
            await VerifyCSharpDiagnosticAsync(source, Descriptors.PX1084_GraphCreationInDataViewDelegate.CreateFor(10, 25));
        ...
        public async Task ViewDelegateInGraphExtensionOverride(string source) =>
            await VerifyCSharpDiagnosticAsync(source, Descriptors.PX1084_GraphCreationInDataViewDelegate.CreateFor(10, 33));
    }
}
