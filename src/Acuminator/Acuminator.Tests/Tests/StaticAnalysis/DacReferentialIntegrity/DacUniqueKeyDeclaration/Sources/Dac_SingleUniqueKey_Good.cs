...
namespace Acuminator.Tests.Tests.StaticAnalysis.DacReferentialIntegrity.Sources
{
	...
	public class SOOrder : IBqlTable
	{
		...
		public class UK : PrimaryKeyOf<SOOrder>.By<orderType, status>
		{
			public static SOOrder Find(PXGraph graph, string orderType, string status) => FindBy(graph, orderType, status);
		}
