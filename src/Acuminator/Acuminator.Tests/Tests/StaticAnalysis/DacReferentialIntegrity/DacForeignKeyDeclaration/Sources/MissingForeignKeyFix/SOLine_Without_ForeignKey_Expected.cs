...
namespace Acuminator.Tests.Tests.StaticAnalysis.DacReferentialIntegrity.Sources.MissingForeignKeyFix
{
	...
	public partial class SOLine : PX.Data.IBqlTable
	{
		...
		public static class FK
		{
			...
			// public class ReferencedDacFK : ReferencedDAC.PK.ForeignKeyOf<SOLine>.By<joinField1, joinFields, ...> { }
			//
			// For referenced DACs without a PK class and with a single primary key field, you can use the following template:
			// public class ReferencedDacFK : Field<joinField>.IsRelatedTo<ReferencedDAC.keyField>.AsSimpleKey.WithTablesOf<ReferencedDAC, SOLine> { }
			//
			...
			//
			// You can start with the following properties:
			// BranchID,
			// OrderType,
			// OrderNbr,
			// OrderDate,
