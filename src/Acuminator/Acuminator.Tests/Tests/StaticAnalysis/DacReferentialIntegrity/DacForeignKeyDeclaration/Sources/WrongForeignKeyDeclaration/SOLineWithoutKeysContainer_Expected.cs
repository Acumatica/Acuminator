...
{
	[PXCacheName("SO Line")]
	public partial class SOLineWithoutKeysContainer : IBqlTable
	{
		public class PK : PrimaryKeyOf<SOLineWithoutKeysContainer>.By<orderType, orderNbr, lineNbr>
		{
			public static SOLineWithoutKeysContainer Find(PXGraph graph, string orderType, string orderNbr, int? lineNbr) => FindBy(graph, orderType, orderNbr, lineNbr);
		}
		...
		public static class FK
		{
			public class SOOrderCompositeFK : CompositeKey<
									 ...
									 >
									 .WithTablesOf<SOOrder, SOLineWithoutKeysContainer>
			{ }

			public class InventorySimpleFK : Field<inventoryID>.IsRelatedTo<InventoryItem.inventoryID>.AsSimpleKey.WithTablesOf<InventoryItem, SOLineWithoutKeysContainer> { }
		}
