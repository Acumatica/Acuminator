...
| [PX1041](diagnostics/PX1041.md) | Graph event handlers with a weakly typed signature that relies on naming conventions can be converted to graph event handlers with strongly typed generic signature. | Information | Available |
