...
| [PX1008](diagnostics/PX1008.md) | The reference to the screen graph or an action adapter in the long operation and processing delegates cause synchronous execution of the delegate. | Warning (ISV Level 1: Significant) | Unavailable |
