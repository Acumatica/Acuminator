...
The diagnostic does not check abstract DACs and or DACs which that have only unbound DAC properties (fully-unboundfully unbound DACs used for custom popups pop-ups and filters for inquiry forms).
