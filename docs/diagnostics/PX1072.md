...
The diagnostic also displays the warning when a class contains multiple BQL or Fluent BQL queries and no graph is available in the context as shown in the following example.
```C#
