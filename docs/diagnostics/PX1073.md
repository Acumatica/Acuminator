...
The diagnostic does not show an error if the following exceptions and their descendants thrown in the `RowPersisted` event handler of a processing graph:
