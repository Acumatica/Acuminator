...
- A namespace containing the API is in the list of banned APIs.
- The type containing the API is in the list of banned APIs. In case of nested types, the API is banned if any of containing types is in hte list of banned APIs.
